...
- :fire: <span>**Расширяемость**: расширяйте библиотеку с помощью кастомных [границ слов](./advanced/boundaries.md) и [регистров текста](./advanced/cases.md).</span>
...
Вы можете узнать больше о границах [тут](./advanced/boundaries.md).
...
По умолчанию символы [пунктуации][string.punctuation] удаляются (исключая
[`delimiter`][textcase.Case.delimiter] текущего регистра), а другие специальные символы игнорируются.
